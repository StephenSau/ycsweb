(function (requirejs) {
    ...
    requirejs(['jquery', "sersAddrsCtrl", 'serviceCtrl', 'common', 'formVerified', 'experts', 'dialog', 'carousel', "chosen"], function ($, sersAddrsCtrl, serviceCtrl, common, FormVerified, Experts, dialog) {
        ...
        Index.prototype = {
            init: function () {
                var that = this,
                    serviceSearchForm = document.getElementById('serviceSearchForm'),
                    searchVerifition = new FormVerified(serviceSearchForm, function () {
                        window.location.href = '/fuwu/' + 
                                                serviceSearchForm.pcode.value + '-' + 
                                                serviceSearchForm.ccode.value + '-' +
                                                serviceSearchForm.id.value + '-' +
                                                serviceSearchForm.province.value + '-' +
                                                serviceSearchForm.city.value + '-' +
                                                serviceSearchForm.area.value
                    }),
